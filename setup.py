...
setup(
  ...
  version = '0.1.1.26',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/jhparkastro/gpcal/archive/v0.1.1.3.tar.gz',    # I explain this later on
